import requests, time, re, json, os, random
...
def main(url):
    ...
    # 下载图片，这里可以修改为多线程的
    print("开始下载漫画")
    for chapt_index, chapt_dic in enumerate(chapt_info[start_chapt:end_chapt], start=1):
        get_pic(chapt_dic, comic_title, chapt_index)
